...
<p align="center">
  ...
  <img alt="Status" src="https://img.shields.io/badge/Open%20to-Internship-22c55e">
</p>

---

## 🧭 About me
I’m a 5th-year MIAGE student at **EMSI Marrakech** building end-to-end products—from RESTful backends and secure auth to responsive UIs and DevOps basics. I enjoy solving real problems and I’m growing toward a **techno-functional ERP/CRM** role.
...
## 🛠️ Tech Stack (from the tools I use most)
**Languages:** Java · JavaScript/TypeScript · PHP · Python · C · C# · C++ · HTML · CSS  
**Backend:** Spring Boot · Java EE · Hibernate/JPA · Node.js/Express · .NET/WPF · REST APIs · JUnit  
**Frontend:** React · Redux · Tailwind CSS · Bootstrap · Qt  
**Mobile/Desktop:** Android (Java) · WPF (.NET)  
**Data/DB:** MySQL · SQL Server · PostgreSQL · Oracle · SQLite  
**DevOps/Cloud:** Git · GitHub · Docker · Azure DevOps · Microsoft Azure  
**Other:** Firebase · Git (Git Flow) · Linux · MATLAB · TensorFlow

<!-- Icon badges (simpleicons via shields) -->
<p align="left">
  <!-- row 1 -->
...
## 🏗️ Featured Projects
<details open>
  <summary><b>Full-Stack — Nobu Hotel</b> · <i>Spring Boot, React, JWT, Dialogflow</i></summary>
  <ul>
    <li>Digitized hotel services with role-based access and JWT (Spring Security).</li>
    <li>AI assistant for FAQs (reservations, schedules, offers).</li>
    <li>Admin panel for request tracking, validation & analytics.</li>
  </ul>
</details>

<details>
  <summary><b>Cosmos Technologie — Gaming E-commerce</b> · <i>Spring Boot, React, MySQL, Docker</i></summary>
  <ul>
    <li>Admin back-office, stock/promo management, CSV export, secure payments.</li>
  </ul>
</details>

<details>
  <summary><b>SmartCare — Personalized Medical Follow-up</b> · <i>Android (Java), React, Dialogflow</i></summary>
  <ul>
    <li>Mobile & web app with chatbot for FAQs and appointment assistance.</li>
  </ul>
</details>

<details>
  <summary><b>Tele-consultation & Booking</b> · <i>Spring Boot, React, MySQL</i></summary>
  <ul>
    <li>End-to-end flow for patients, doctors, slots, reservations.</li>
  </ul>
</details>

<details>
  <summary><b>Hotel Reservation Desktop</b> · <i>C#, WPF, ASP.NET, SQL Server</i></summary>
  <ul>
    <li>Real-time availability checks & intuitive UI.</li>
  </ul>
</details>
...
<p>
  <img height="140" src="https://github-readme-stats.vercel.app/api/top-langs/?username=BrahimElm01&layout=compact&langs_count=8" />
</p>
