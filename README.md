...
- **Full-Stack — Nobu Hotel**  
  Built a web app to digitize hotel services with role-based access and JWT (Spring Security); added an AI assistant for FAQs (reservations, services, schedules, offers); delivered an admin panel for request tracking, validation, analytics.  
  <sub>Stack: React · TypeScript · Tailwind · Spring Boot · Spring Security · MySQL · Docker · REST · GitHub · JUnit · Axios · Dialogflow</sub>
...
- **Cosmos Technologie – Gaming E-commerce**  
  ...
  <sub>Stack: Java · Spring Boot · React · MySQL · Docker</sub>

- **SmartCare – Personalised Medical Follow-up**  
  Mobile & web app with an AI chatbot for FAQs and appointment assistance.  
  <sub>Stack: Android (Java) · React · Dialogflow · SQLite/MySQL</sub>

- **Tele-consultation & Booking Platform**  
  End-to-end telemedicine workflow (patients, doctors, slots, reservations).  
  <sub>Stack: Spring Boot · React · MySQL</sub>
